...
Router.route('/posts/:_id',{
	...
	data: function() {return Posts.findOne(this.params._id);}
		//{return Summaries.findOne(this.params._id));}
});
...
Router.route('/post/:_id',function(){
	...
	data: function() {
		return Posts.findOne(Post_summary.findOne({summaryID: this.params._id}).postID);
	}
});
...
Router.route('/dictionary', {
	name: 'dictionaries',
	data: function() {return Dictionary.find(); }
});

Router.route('/dictionary/:_id', {
	name: 'dictionaryPage',
	data: function() {return Dictionary.findOne({_id: this.params._id}); }
});
