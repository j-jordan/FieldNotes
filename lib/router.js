...
Router.route('/posts/:_id',{
	name: 'postPage',
	data: function() {return {postData: Posts.findOne(this.params._id)};}
});
...
Router.route('/post/:_id',function(){
	...
	data: function() {
		templateData = {
			postData: Posts.findOne(Post_summary.findOne({summaryID: this.params._id}).postID),
...
Router.route('/submitSummary/:postData._id' , {
	name: 'submitSummary',
	data: function() { 
		return Posts.findOne(this.params.postData._id);}
});	
